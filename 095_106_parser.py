...
path = r'C:\Users\HP\Downloads\2016-20201206T170536Z-001'
...
full_file_name = path + '\\' + folder + '\\' + '095-106 оборот розничной торговли-3.xls'
catchError = False
...
try:
    ...
    for i in range(len(sheets)):
        ...
        code = codes[i]
        if i == 3:
            file = pd.read_excel(full_file_name, header=[0, 1, 2], sheet_name=sheet_name, index_col=0)
        else:
